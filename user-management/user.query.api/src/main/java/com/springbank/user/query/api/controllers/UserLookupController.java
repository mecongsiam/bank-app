...
public class UserLookupController {
    ...
    @Autowired
    public UserLookupController(QueryGateway queryGateway, UserRepository userRepository) {
    ...
    public ResponseEntity<User> searchUserByFilter(@RequestBody User user) {
